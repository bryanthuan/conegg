      ...
      <section>
        ...
        <div class="author-card">
          <md-avatar class="md-large">
            <img src="img/assets/brianthuan.jpg" alt="Brian Thuan">
          </md-avatar>
          <div class="author-card-info">
            <span>Brian Thuan</span>
            <div class="author-card-links">
              <a href="https://github.com/thuann89" target="_blank" rel="noopener">GitHub</a>
              <a href="https://www.linkedin.com/in/brianthuan" target="_blank" rel="noopener">Linkedin</a>
            </div>
          </div>
        </div>
      </section>
